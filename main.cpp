...
#define APP_TITLE "Parallax Mapping"
...
void RenderCube()
{
	...
	case 0:
		if (g_enableParallax)
			hTechnique = g_pEffect->GetTechniqueByName("ParallaxMapping");
	break;
	case :
		if (g_enableParallax)
			hTechnique = g_pEffect->GetTechniqueByName("ParallaxMappingStep");
		break;
	case 2:
		if (g_enableParallax)
			hTechnique = g_pEffect->GetTechniqueByName("ParallaxMappingRelief");
		break;
	case 3:
		if (g_enableParallax)
			hTechnique = g_pEffect->GetTechniqueByName("ParallaxMappingOclusion");
		break;
